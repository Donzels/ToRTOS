...
#define CoreDebug_DHCSR_S_RETO_ST_Pos   26U                                            /*!< \deprecated CoreDebug DHCSR: S_RETO_ST Position */
#define CoreDebug_DHCSR_S_RETO_ST_Msk   (1UL << CoreDebug_DHCSR_S_RETO_ST_Pos)      /*!< \deprecated CoreDebug DHCSR: S_RETO_ST Mask */
...
#define DCB_DHCSR_S_RETO_ST_Pos         26U                                            /*!< DCB DHCSR: Restart sticky status Position */
#define DCB_DHCSR_S_RETO_ST_Msk         (0x1UL << DCB_DHCSR_S_RETO_ST_Pos)          /*!< DCB DHCSR: Restart sticky status Mask */
