...
#define LL_FMPI2C_GENERATE_TO_READ          (uint32_t)(0x80000000U | FMPI2C_CR2_START | FMPI2C_CR2_RD_WRN)
/*!< Generate Start for read request. */
#define LL_FMPI2C_GENERATE_TO_WRITE         (uint32_t)(0x80000000U | FMPI2C_CR2_START)
/*!< Generate Start for write request. */
#define LL_FMPI2C_GENERATE_RETO_7BIT_READ   (uint32_t)(0x80000000U | FMPI2C_CR2_START | FMPI2C_CR2_RD_WRN)
/*!< Generate Restart for read request, slave 7Bit address.  */
#define LL_FMPI2C_GENERATE_RETO_7BIT_WRITE  (uint32_t)(0x80000000U | FMPI2C_CR2_START)
/*!< Generate Restart for write request, slave 7Bit address. */
#define LL_FMPI2C_GENERATE_RETO_10BIT_READ  (uint32_t)(0x80000000U | FMPI2C_CR2_START | \
                                                          FMPI2C_CR2_RD_WRN | FMPI2C_CR2_HEAD10R)
/*!< Generate Restart for read request, slave 10Bit address. */
#define LL_FMPI2C_GENERATE_RETO_10BIT_WRITE (uint32_t)(0x80000000U | FMPI2C_CR2_START)
...
/**
  ...
  *         @arg @ref LL_FMPI2C_GENERATE_TO_READ
  *         @arg @ref LL_FMPI2C_GENERATE_TO_WRITE
  *         @arg @ref LL_FMPI2C_GENERATE_RETO_7BIT_READ
  *         @arg @ref LL_FMPI2C_GENERATE_RETO_7BIT_WRITE
  *         @arg @ref LL_FMPI2C_GENERATE_RETO_10BIT_READ
  *         @arg @ref LL_FMPI2C_GENERATE_RETO_10BIT_WRITE
  * @retval None
  */
