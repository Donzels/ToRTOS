...
#define  FMPSMBUS_GENERATE_TO_READ              (uint32_t)(0x80000000U | FMPI2C_CR2_START | FMPI2C_CR2_RD_WRN)
#define  FMPSMBUS_GENERATE_TO_WRITE             (uint32_t)(0x80000000U | FMPI2C_CR2_START)
/**
  * @}
  */
...
#define IS_FMPSMBUS_TRANSFER_REQUEST(REQUEST)              (((REQUEST) == FMPSMBUS_GENERATE_STOP)              || \
                                                            ((REQUEST) == FMPSMBUS_GENERATE_TO_READ)        || \
                                                            ((REQUEST) == FMPSMBUS_GENERATE_TO_WRITE)       || \
