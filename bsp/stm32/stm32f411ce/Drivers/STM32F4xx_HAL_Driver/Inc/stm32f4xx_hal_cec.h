...
typedef struct
{
  ...
  uint32_t SignalFreeTimeOption;         /*!< Set SFTOP bit CEC_SFT_Option : specifies when SFT timer starts.
                                              CEC_SFT_TO_ON_TXSOM SFT:    timer starts when TXSOM is set by software.
                                              CEC_SFT_TO_ON_TX_RX_END:  SFT timer starts automatically at the end
...
/** @defgroup CEC_SFT_Option     CEC Signal Free Time start option
  * @{
  */
#define CEC_SFT_TO_ON_TXSOM           ((uint32_t)0x00000000U)
#define CEC_SFT_TO_ON_TX_RX_END       ((uint32_t)CEC_CFGR_SFTOPT)
/**
  * @}
  */
...
/** @brief  Get Transmission Start flag
  ...
  * @retval FlagStatus
  */
#define __HAL_CEC_GET_TRANSMISSION_TO_FLAG(__HANDLE__) ((__HANDLE__)->Instance->CR & CEC_CR_TXSOM)
...
#define IS_CEC_SFTOP(__SFTOP__)          (((__SFTOP__) == CEC_SFT_TO_ON_TXSOM) || \
                                          ((__SFTOP__) == CEC_SFT_TO_ON_TX_RX_END))
