...
#define RWTO_BITNUMBER         0x08U
#define DCTRL_RWTO_BB          (PERIPH_BB_BASE + (DCTRL_OFFSET * 32U) + (RWTO_BITNUMBER * 4U))
...
/**
  ...
  * @retval None
  */
#define __SDIO_TO_READWAIT_ENABLE(__INSTANCE__)  (*(__IO uint32_t *) DCTRL_RWTO_BB = ENABLE)
...
/**
  ...
  * @retval None
  */
#define __SDIO_TO_READWAIT_DISABLE(__INSTANCE__)  (*(__IO uint32_t *) DCTRL_RWTO_BB = DISABLE)
