...
/**
  ...
  *     @arg @ref FMPSMBUS_GENERATE_TO_READ Generate Restart for read request.
  *     @arg @ref FMPSMBUS_GENERATE_TO_WRITE Generate Restart for write request.
  * @retval None
  */
static void FMPSMBUS_TransferConfig(FMPSMBUS_HandleTypeDef *hfmpsmbus,  uint16_t DevAddress, uint8_t Size,
                                    uint32_t Mode, uint32_t Request)
